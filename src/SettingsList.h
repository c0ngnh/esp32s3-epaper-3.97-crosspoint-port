...
inline bool settingHiddenOnEpaper397(const SettingInfo& s) {
  return s.nameId == StrId::STR_SIDE_BTN_LAYOUT || s.nameId == StrId::STR_LONG_PRESS_BEHAVIOR ||
         s.nameId == StrId::STR_SHORT_PWR_BTN || s.nameId == StrId::STR_SLEEP_SCREEN ||
         s.nameId == StrId::STR_SLEEP_COVER_MODE || s.nameId == StrId::STR_SLEEP_COVER_FILTER;
}
#endif
...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_REFRESH_FREQ, &CrossPointSettings::refreshFrequency,
                          {StrId::STR_PAGES_30, StrId::STR_PAGES_45, StrId::STR_PAGES_60}, "refreshFrequency",
                          StrId::STR_CAT_DISPLAY),
#else
        SettingInfo::Enum(
        ...
        SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                          {StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED, StrId::STR_THEME_ROUNDEDRAFF},
  ...
  v.erase(std::remove_if(v.begin(), v.end(),
                         [](const SettingInfo& s) { return settingHiddenOnEpaper397(s); }),
          v.end());
#endif
  return v;
}
