...
inline constexpr int kThemeButtonHintsHeight = 0;
inline constexpr int kThemeSideButtonHintsWidth = 0;
#else
inline constexpr int kThemeButtonHintsHeight = 40;
inline constexpr int kThemeSideButtonHintsWidth = 30;
#endif
...
// Base theme implementation; Lyra / RoundedRaff / etc. inherit and override as needed.
...
constexpr ThemeMetrics values = {.batteryWidth = 15,
                                 ...
                                 .buttonHintsHeight = kThemeButtonHintsHeight,
                                 .sideButtonHintsWidth = kThemeSideButtonHintsWidth,
...
#if defined(BOARD_ESP32_S3_EPAPER_397)
  // SHTC3 + RTC on the top row (left / center). Battery stays on the right in drawHeader().
  static constexpr int BOARD397_TOP_BAR_HEIGHT = 18;
  static int getBoard397TopBarReservedHeight();
  static void drawBoard397HeaderRow(const GfxRenderer& renderer, int headerY, int sidePadding,
                                    bool showEnvironment = true);
  static void drawBoard397TopStatusRow(const GfxRenderer& renderer);
#endif
};
